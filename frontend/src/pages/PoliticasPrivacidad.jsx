      ...
      <main className="max-w-5xl mx-auto px-8 py-10">
        ...
        <section className="bg-white border border-gray-200 rounded-3xl shadow-sm p-8 md:p-10">
          ...
          <p className="text-gray-700 leading-relaxed">
            Esta sección está pendiente de redacción legal. Aquí se explicará cómo
            Econnet recopila, utiliza y protege la información de los usuarios,
            incluyendo datos de contacto, compras, direcciones y preferencias.
          </p>
